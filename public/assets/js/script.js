        ...
        initAddStudent: function(){
            ...
            $('#sbt-student').on('click', function(e){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        s_name: $('#s_name').val().replace(/\b\w/g, function(l){ return l.toUpperCase() }),
                        f_name: $('#f_name').val().replace(/\b\w/g, function(l){ return l.toUpperCase() }),
                        m_name: $('#m_name').val() ? $('#m_name').val().replace(/\b\w/g, function(l){ return l.toUpperCase() }) : '',
