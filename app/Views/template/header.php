...
<head>
  ...
  <title><?php echo $page_title; ?> &ndash; SVCA</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url('public/assets/css/flatpickr.min.css');?>" />
  <link rel="stylesheet" href="<?php echo base_url('public/assets/css/monthSelect.min.css');?>" />
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
					...
					<a class="nav-link " href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown"
						aria-expanded="false">
						<img src="<?php echo base_url('public/assets/images/profile/user-1.jpg');?>" alt="" width="35" height="35" class="rounded-circle">
					</a>
					<div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
						<div class="message-body">
						<a href="<?php echo base_url('user/profile'); ?>" class="d-flex align-items-center gap-2 dropdown-item">
